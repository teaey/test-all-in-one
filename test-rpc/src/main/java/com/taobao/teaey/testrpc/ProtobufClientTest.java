...
public class ProtobufClientTest {
    public static void main(String[] args) {
        ...
        for(int i=0;i<100000;i++){
            client.ask(LostProto.Packet.newBuilder().setPId(1).setMethodName("login").setServiceName("com.taobao.teaey.testrpc.LoginService").setTimestamp(System.currentTimeMillis()).setData(TestProto.Login_C2S.newBuilder().setTimestamp(System.currentTimeMillis()).build().toByteString()));
            try {
                Thread.sleep(2000);
