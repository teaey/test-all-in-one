...
public class PbRpcChannel implements RpcChannel, BlockingRpcChannel {
    ...
    public void callMethod(Descriptors.MethodDescriptor method, RpcController controller,
        ...
        log.debug("---> callMethod sName={}, sIndex={}, mName={}, mIndex={}",
            method.getService().getFullName(), method.getService().getIndex(), method.getFullName(),
            method.getIndex());
    ...
    public Message callBlockingMethod(Descriptors.MethodDescriptor method, RpcController controller,
        ...
        log.debug("---> callBlockingMethod sName={}, sIndex={}, mName={}, mIndex={}",
            method.getService().getFullName(), method.getService().getIndex(), method.getFullName(),
            method.getIndex());
        return null;
    }
