...
public class PbTest {
    ...
    public static void testServer() throws ServiceException, ClassNotFoundException {
        ...
        System.out.println(descriptor.getFullName() + " " + descriptor.getName() + " " + descriptor.getFile().getName() + " " + descriptor.getIndex() +" " +  descriptor.getOptions());
    ...
    public static void testClient() throws ServiceException {
        ...
        noBlockingService.login(controller, PbDemoProto.Login_C2S.newBuilder().setTimestamp(System.currentTimeMillis()).build(), pbr);
